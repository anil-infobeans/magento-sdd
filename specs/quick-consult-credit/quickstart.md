...
**Input**: [contracts/rest-api.md](./contracts/rest-api.md); [data-model.md](./data-model.md); [configuration.md](./configuration.md); [testing-and-acceptance.md](./testing-and-acceptance.md)
...
- Consultation Services attribute set exists, with a Quick Consult Credit product assigned to it ([product-configuration.md](./product-configuration.md) QCC-PROD-001/002).
- Module configuration set ([configuration.md](./configuration.md)):
...
**Negative check**: Repeat the exact same request (same `request_reference` if supplied, or immediately retried). Balance must not decrease a second time (QCC-REDEEM-010).
...
**Expected outcome**: All suites pass, covering the scenarios in [testing-and-acceptance.md](./testing-and-acceptance.md) Consolidated Acceptance Test Scenarios.
